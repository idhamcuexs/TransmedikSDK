...
////
        //production
        Transmedik.Transmedik_Login(email: "stella@weplus.id", gender: "P", device_id: "ddrsUz__QoOoNLnZ4vLdkz:APA91bGKsrxPY0IRBJ3PwXBoSLRqD-OAL9vaWGkXXv2Q9FLkMjcgwvImwD-X9pt6Ut0g2ZLfbfYirq2OGIaS-aY8ItdSmB_yn-Ab_CUNpH12T9P0EJ96fLLT2-QCKvcW6aYZmUFiYzA4", identification: "KIP-090", name: "IVAN JOHN", nik: "3578045502960004", phone_number: "081703404060") { status, msg in
            if status{
