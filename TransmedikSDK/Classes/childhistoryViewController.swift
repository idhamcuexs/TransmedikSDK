...
//        print(self.nextpage)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if data[indexPath.row].type_history == "1"{
            let vc = UIStoryboard(name: "Ordertracking", bundle: AppSettings.bundleframeworks()).instantiateViewController(withIdentifier: "NewTrackingViewController") as? NewTrackingViewController
...
extension childhistoryViewController: historiescellkonsulTableViewCelldelegate,ratingViewControllerdelegate{
    ...
    func chatulang(row: Int) {
        let vc = UIStoryboard(name: "Profiledokter", bundle: AppSettings.bundleframeworks()).instantiateViewController(withIdentifier: "profiledoktermasterViewController") as? profiledoktermasterViewController
    ...
    func nilai(row: Int) {
        let vc = UIStoryboard(name: "rating", bundle: AppSettings.bundleframeworks()).instantiateViewController(withIdentifier: "ratingViewController") as? ratingViewController
