//
//  cellHistoryTableViewCell.swift
//  TransmedikSDK_Example
//
//  Created by Idham Kurniawan on 24/12/21.
...
protocol cellHistoryTableViewCellDelegate{
    func chatulang(row:Int)
    func nilai(row:Int)
}

class cellHistoryTableViewCell: UITableViewCell {

        static let identifier = "cellHistoryTableViewCell"
        static func nib() -> UINib {
            return UINib(nibName: "cellHistoryTableViewCell", bundle: AppSettings.bundleframeworks())
        }
...
//    @IBOutlet weak var penilaian: UIView!
    ...
    var delegate :cellHistoryTableViewCellDelegate!
